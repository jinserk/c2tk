...
c.ServerApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$HMpPxA30dlRY3twMNiLXtw$CsN1uCwdcWHM4Et52mYQPg'
...
#  Choices: any of ['md5', 'sha256', 'blake2b', 'sha3_384', 'sha3_224', 'sha3_256', 'sha3_512', 'sha224', 'sha384', 'sha512', 'blake2s', 'sha1']
#  Default: 'sha256'
