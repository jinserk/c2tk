...
c.NotebookApp.allow_origin = 'host.docker.internal'
...
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$HMpPxA30dlRY3twMNiLXtw$CsN1uCwdcWHM4Et52mYQPg'
...
#  Choices: any of ['blake2s', 'sha1', 'sha3_224', 'sha3_384', 'md5', 'sha3_256', 'sha3_512', 'sha256', 'sha384', 'sha224', 'blake2b', 'sha512']
#  Default: 'sha256'
